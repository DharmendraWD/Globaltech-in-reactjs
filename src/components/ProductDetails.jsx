...
import { STATUSES, fetchproductsDetails } from '../redux/productDetailSlice'; // Ensure this path is correct
...
const ProductDetails = () => {
  ...
  useEffect(() => {
    if (id) {
      dispatch(fetchproductsDetails(`https://dummyjson.com/products/1`));
    }
  }, [dispatch]);
  ...
  return (
    <div className="mt-[100px]">
      {status === STATUSES.SUCCEEDED && product.id ? (
